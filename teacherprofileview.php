...
<?php
 ...
 $email= mysqli_real_escape_string($dbcon, $_POST['profilesearch']);
 
$sql = "SELECT * FROM teacher where username='$email'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
       ...
       echo "<tr>"."<th>"."Employee Number : " ."</th>"."<td>".$row["teacherid"]."</td>"."</tr>";
