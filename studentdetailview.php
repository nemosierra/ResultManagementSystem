...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<tr>"."<th>"."Roll" ."</th>"."<th>"."First Name" ."</th>"."<th>"."Last Name" ."</th>"."<th>"."Date of Birth" ."</th>"."<th>"."Gender" ."</th>"."<th>"."Department" ."</th>"."<th>"."Email" ."</th>"."<th>"."Class" ."</th>"."<th>"."Division" ."</th></tr>";    

    while($row = mysqli_fetch_assoc($result)) {
        
        echo "<tr>"."<td>".$row['Roll']."</td>"."<td>".$row["fname"]."</td>"."<td>".$row["lname"]."</td>"."<td>".$row["dob"]."</td>"."<td>".$row["gender"]."</td>"."<td>".$row["department"]."</td>"."<td>".$row["username"]."</td>"."<td>".$row["class"]."</td>"."<td>".$row["division"]."</td>"."</tr>";
